"""_summary_
    the get method for a LinkedList
    pass in the index and get the value
"""
...
class LinkedList:
    ...
    def get(self, index):
        # check if length is that long, if not return None
        if index < 0 or self.length <= index:
            return None
        # need to traverse through list until that index - 1
        temp = self.head
